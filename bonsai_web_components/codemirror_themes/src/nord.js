...
var invalid = '#d30102',
    ...
    selection = base03,
    cursor = base04; /// The editor theme styles for Nord.
...
var nordTheme = {
  ...
  '.cm-searchMatch': {
    ...
    outline: "1px solid ".concat(base07)
  },
...
globalThis.cm6_themes_nordTheme = nordTheme;

function nordHighlightStyle(){
...
globalThis.cm6_themes_nordHighlightStyle = nordHighlightStyle;
