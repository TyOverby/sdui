...
let%expect_test "render some notifications and test that they close as expected" =
  ...
  [%expect
    ...
    +|    <div @key=0 data-notification-id="0" class="notification_hash_replaced_in_test" @on_click>
  ...
  [%expect
    ...
    +|    <div @key=1 data-notification-id="1" class="notification_hash_replaced_in_test" @on_click>
  ...
  [%expect
    ...
    +|    <div @key=2 data-notification-id="2" class="notification_hash_replaced_in_test" @on_click>
    +|      <div class="notification_body_hash_replaced_in_test success_hash_replaced_in_test"
    +|           style={
    +|             animation-name: fadeOut;
    +|             animation-duration: 15.00s;
    ...
    +|    <div @key=3 data-notification-id="3" class="notification_hash_replaced_in_test" @on_click>
    +|      <div class="notification_body_hash_replaced_in_test success_hash_replaced_in_test"
    +|           style={
    +|             animation-name: fadeOut;
    +|             animation-duration: 15.00s;
