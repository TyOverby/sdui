...
module Test = struct
  ...
  type ('a, 'column_id) t =
    ...
    ; input_var : outer Int.Map.t Bonsai.Expert.Var.t
    ; filter_var : (key:int -> data:outer -> bool) Bonsai.Expert.Var.t
    }

  let focus_changed =
    Bonsai.return (fun focus_changed_to ->
  ...
  module Component = struct
    ...
    let get_inject_cell_focus' t ~get_focus ~get_set_column_width =
      ...
      | Focus_leftmost -> Focus_control.focus_leftmost focus
      | Focus_rightmost -> Focus_control.focus_rightmost focus
