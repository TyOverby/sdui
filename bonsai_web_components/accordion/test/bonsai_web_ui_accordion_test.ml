...
let%expect_test "Clicking open and close" =
  ...
  [%expect
    ...
    is_open: false
    -----------------
    <div class="container" @on_click>
      <div data-test="title" class="title-bar title-text title_closed title" @on_click>
        <div>
  ...
  [%expect
    ...
    -----------------
    <div class="container" @on_click>
      <div data-test="title" class="title-bar title-text title title_open" @on_click>
        <div>
          <div class="icon-container">
...
let%expect_test "Opening and closing via effects" =
  ...
  [%expect
    ...
    -----------------
    <div class="container" @on_click>
      <div class="title-bar title-text title_closed title" @on_click>
        <div>
          <div class="icon-container">
            <div class="accordion-closed icon"> </div>
          </div>
  ...
  [%expect
    ...
    +|is_open: true
      ...
      <div class="container" @on_click>
    -|  <div class="title-bar title-text title_closed title" @on_click>
    +|  <div class="title-bar title-text title title_open" @on_click>
          <div>
            <div class="icon-container">
    -|        <div class="accordion-closed icon"> </div>
    +|        <div class="accordion-open icon"> </div>
