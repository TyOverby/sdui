...
let component render graph =
  let%sub lists, dragged_element =
    Reorderable_list.Multi.simple
      ...
      ~render
      ~lists:(Bonsai.return (Int.Set.of_list [ 0; 1; 2 ]))
      ~default_list:(Bonsai.return 0)
      (Bonsai.return (Int.Set.of_list [ 0; 1; 2; 3 ]))
      graph
  in
  let lists =
    Bonsai.assoc
    ...
    <div>
      <div>
        <div>
          <h3> List 0 </h3>
          <div>
            <div data-drag-target="(0 0)" style={ transform: translateY(0px) translateX(0px); }>
              <div> 0 </div>
            </div>
            <div data-drag-target="(0 1)" style={ transform: translateY(40px) translateX(0px); }>
              <div> 1 </div>
            </div>
            <div data-drag-target="(0 2)" style={ transform: translateY(80px) translateX(0px); }>
              <div> 2 </div>
            </div>
            <div data-drag-target="(0 3)" style={ transform: translateY(120px) translateX(0px); }>
              <div> 3 </div>
            </div>
          </div>
        </div>
    ...
    <div>
      <div>
        ...
        <div>
          <h3> List 1 </h3>
          <div>
            <div data-drag-target="(1 0)" style={ transform: translateY(0px) translateX(0px); }>
              <div> 0 </div>
            </div>
          </div>
        </div>
