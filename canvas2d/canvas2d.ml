...
module Canvas1 = struct
  ...
  let create ~width ~height : t =
    ...
    := Dom_float.to_js_string
         (Int.to_float width /. Js.float_of_number Dom_html.window##.devicePixelRatio);
    canvas##.style##.height
    := Dom_float.to_js_string
         (Int.to_float height /. Js.float_of_number Dom_html.window##.devicePixelRatio);
...
module Ctx2d1 = struct
  ...
  let draw_canvas ?sx ?sy ?sw ?sh ?w ?h ((_, ctx) : t) (canvas : Canvas1.t) ~x ~y =
    ...
    ctx##drawImage_fullFromCanvas
      ...
      (Js.number_of_float sx)
      (Js.number_of_float sy)
      (Js.number_of_float sw)
      (Js.number_of_float sh)
      (Js.number_of_float x)
      (Js.number_of_float y)
      (Js.number_of_float w)
  ...
  let get_image_data ?(x = 0) ?(y = 0) ?w ?h ((canvas, ctx) : t) =
    ...
    let obj =
      ctx##getImageData
        (Js.number_of_float (Int.to_float x))
        (Js.number_of_float (Int.to_float y))
        (Js.number_of_float (Int.to_float w))
        (Js.number_of_float (Int.to_float h))
    in
